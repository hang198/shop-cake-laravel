                        ...
                        <div class="cart">
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                <div class="cart-caption">
                                    <div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{ number_format(Session('cart')->totalPrice) }} VND</span>
                                    </div>
                                    <div class="clearfix"></div>
        ...
        <div class="container">
            ...
            <nav class="main-menu">
                <ul class="l-inline ov">
                    ...
                    <li><a href="{{ route('product_type',1) }}">Loại sản phẩm</a>
                        <ul class="sub-menu">
                            @foreach($product_type as $pt)
                                <li><a href="{{ route('product_type',$pt->id) }}">{{ $pt->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
